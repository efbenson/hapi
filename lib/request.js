...
exports = module.exports = internals.Request = class {
    ...
    _setUrl(source, stripTrailingSlash, { fast }) {
        ...
        this.query = this._parseQuery(url.searchParams, url.rawQueryString);
    ...
    _parseQuery(searchParams, rawQueryString) {
        ...
        if (parser) {
            query = parser(query, rawQueryString);
            if (!query ||
                typeof query !== 'object') {
